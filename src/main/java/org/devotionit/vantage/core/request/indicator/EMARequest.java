...
import static org.devotionit.vantage.core.request.param.Function.EMA;

/**
 * @author Strahinja Mitrović
 */
@Data
public class EMARequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public EMARequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(EMA, interval);
