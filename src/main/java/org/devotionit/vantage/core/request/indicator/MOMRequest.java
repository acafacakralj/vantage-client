...
import static org.devotionit.vantage.core.request.param.Function.MOM;

/**
 * @author Strahinja Mitrović
 */
@Data
public class MOMRequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public MOMRequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(MOM, interval);
