...
import static org.devotionit.vantage.core.request.param.Function.DEMA;

/**
 * @author Strahinja Mitrović
 */
@Data
public class DEMARequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public DEMARequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(DEMA, interval);
