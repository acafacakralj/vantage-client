...
import static org.devotionit.vantage.core.request.param.Function.KAMA;

/**
 * @author Strahinja Mitrović
 */
@Data
public class KAMARequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public KAMARequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(KAMA, interval);
