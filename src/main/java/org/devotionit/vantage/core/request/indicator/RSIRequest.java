...
import static org.devotionit.vantage.core.request.param.Function.RSI;

/**
 * @author Strahinja Mitrović
 */
@Data
public class RSIRequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public RSIRequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(RSI, interval);
