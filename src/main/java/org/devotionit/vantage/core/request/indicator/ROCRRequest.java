...
import static org.devotionit.vantage.core.request.param.Function.ROCR;

/**
 * @author Strahinja Mitrović
 */
@Data
public class ROCRRequest extends IndicatorRequest {
  private Symbol symbol;
  private TimePeriod timePeriod;
  private SeriesType seriesType;

  @Builder
  public ROCRRequest(Interval interval, Symbol symbol, TimePeriod timePeriod, SeriesType seriesType) {
    super(ROCR, interval);
